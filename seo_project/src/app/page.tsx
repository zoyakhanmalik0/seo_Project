...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Navigation */}
      <Navigation />
      <div className=" h-[120vh] w-full overflow-hidden lg:mb-0 mb-10">
        {/* Hero Content */}
        <div className=" z-20 lg:mt-0 mt-60 lg:flex items-center justify-between h-full px-6 md:px-20">
          {/* Text Section Left */}
          ...
          <div className="flex-1 z-50 inset-0">
            <LogoAnimation />
          </div>
        </div>
      </div>
     ...
     style={{ backgroundImage: 'url(/media/bg.0f5970d1.png)' }}> */}
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            >
              ...
              <p className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl text-white mb-6 sm:mb-8">
                to grow your brand
              </p>
            </div>
      ...
      <section className="relative min-h-screen overflow-hidden py-10 sm:py-16 lg:py-20 bg-black overflow-x-hidden">
        {/* 🔴 Bottom Left Ring */}
        <div
          className="absolute top-10 left-[-200px] z-0 pointer-events-none"
          style={{ width: "800px", height: "800px" }}
        >
          <div
            style={{
